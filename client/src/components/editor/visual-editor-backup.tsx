...
const VisualEditor: React.FC<VisualEditorProps> = ({
  ...
  // Component renderer local pour les cas spéciaux
  const LocalComponentRenderer = ({ component }: { component: ComponentDefinition }) => {
    ...
    switch (component.type) {
      ...
      default:
        console.error(`ERREUR ARCHITECTURE: Composant ${component.type} non supporté explicitement !`);
        return (
          <div style={{
            ...style,
            ...
            ⚠️ COMPOSANT NON SUPPORTÉ: {component.type}
          </div>
        );
    }
  };
