...
import { Settings as SettingsIcon, Save, Database, FileText, Palette, Code } from "lucide-react";
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea 
                    id="description" 
                    defaultValue="Créateur de sites web visuel et portable pour intégration VS Code"
                    rows={3}
                  />
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="dbName" placeholder="sitejet_clone" />
                  </div>
                  <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="showGuides" defaultChecked />
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="minifyCode" defaultChecked />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="includeComments" defaultChecked />
                </div>
